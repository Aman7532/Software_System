...
/* Output:
   ...
   Maximum number of simultaneous process per user id - 2048
   Number of clock ticks (jiffy) per second - 100
   Maximum number of open files - 1024
   Size of a page - 4096 bytes
   Total number of pages in the physical memory - 100000
   Number of currently available pages in the physical memory - 20000
*/
